...
int main() {
  ...
  AoCHelper aocHelper{"2023", "'$DAYNAME'"};
...
target_link_libraries(day'$TWODIGITSDAYNAME'_test GTest::gtest GTest::gtest_main day'$TWODIGITSDAYNAME'_lib)' >>"$1"/CMakeLists.txt
}
